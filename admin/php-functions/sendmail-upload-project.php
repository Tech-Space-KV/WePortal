...
<p>Your project '" . $_POST['projecttitle'] . "' has been uploaded successfully.</p>
<br>
...
$pt_heading = "New Incoming Project";
$pt_subject = "New Incoming Project";
$pt_linkurl = "www.pseudoteam.com/weportal";
$pt_sendto = "kunal@pseudoteam.com";
$pt_message = "<p>New Project has been added by customer with below details</p>
<ul>
<li>Project = '" . $_POST['projecttitle'] . "'</li>
