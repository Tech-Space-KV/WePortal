          ...
          <?php
              $query="SELECT * FROM `project_scope` WHERE pscope_project_id = $project_id AND pscope_id like '%$search%'" ;
                  ...
                  <td class="limited-td">
							        ...
							        <td>
                      <a class="btn btn-sm btn-primary ms-2" href="project-restricted-milestone?loc-id=<?php echo $row['pscope_id'] ;?>&startdate=<?php echo $stdate ; ?>&enddate=<?php echo $eddate ; ?>">expand</a>
							        </td>
							    </tr>
							    <?php
