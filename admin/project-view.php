        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="px-3 py-3 mb-3 border border-2 border-primary rounded bg-light">
                ...
                <div class=" mb-3">
                    ...
                    <option selected value="<?php echo $row['mgr_user_id']; ?>"><?php echo $row['mgr_username'] . " (" . $row['mgr_email'] . ")" . " (" . $row['mgr_user_id'] . ")"; ?></option>
            ...
            <button type="submit" name="upload_btn" class="btn btn-primary" onClick="saved_data(<?php echo $project_key; ?>)">Upload</button>
