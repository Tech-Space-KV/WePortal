      ...
      <tbody>
        ...
        ?>
          <tr id="">
            ...
            <td>
              <a class="btn btn-sm btn-primary ms-2" href="project-restricted-task?mil-id=<?php echo $row['pplnr_id']; ?>&startdate=<?php echo $stdate ; ?>&enddate=<?php echo $eddate ; ?>">expand</a>
            </td>
          </tr>
        <?php
