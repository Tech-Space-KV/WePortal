...
.form-signin {
  ...
  padding: 0 !important;
  margin: 0 auto !important; /* Ensure it is centered */
  display: flex;
  justify-content: center;
  align-items: center;
  height: 100vh;
...
.login-box {
  width: 600px !important; /* Make it a square */
  height: 500px !important; /* Same as width to keep it square */
  padding: 30px;
  background: rgba(255, 255, 255, 0.9); /* Almost white, blends with background */
  border-radius: 10px; /* Slight rounded edges */
  box-shadow: 0px 4px 15px rgba(0, 0, 0, 0.2); /* Soft shadow effect */
  display: flex;
  flex-direction: column;
  justify-content: center; /* Center content inside */
  align-items: center; /* Align items inside */
}
...
@media (max-width: 480px) {
  .login-box {
    width: 95% !important; /* Almost full width on small screens */
    height: auto;
    padding: 15px;
